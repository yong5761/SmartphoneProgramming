...
### 기대한 것
Android 앱 개발의 기초와 게임 제작의 전반적인 흐름을 익히고 싶었습니다.
...
### 얻지 못한 것
- 게임 엔진(Unity, Godot 등)과의 비교 관점에서의 학습
- 네트워크 기반 기능(리더보드, 멀티플레이 등) 구현 경험

### 더 좋은 수업이 되기 위한 제안
- 중간 점검 세션이 있으면 방향이 틀어지는 것을 일찍 잡을 수 있을 것 같습니다.
- 과제 요구사항(README 형식, 발표 구성 등)을 학기 초에 미리 공개해주시면 개발과 병행하기 수월할 것 같습니다.
